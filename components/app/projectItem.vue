...
<template>
  ...
  >
    <section
      class="bg-gray-200 max-w-[45rem] hidden sm:block border-black/5 rounded-lg overflow-hidden sm:pr-8 relative h-96 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10"
    >
      <div
      ...
      >
        ...
        <p
          class="mt-2 leading-relaxed text-gray-700 dark:text-white/70 font-700"
        >
          {{ description }}
        </p>
      ...
      <img
        :src="isDev ? imageUrl : '/blog.github.io/' + imageUrl"
